...
local menu        = os.getenv("HOME") .. "/.config/hypr/scripts/menu.sh"
...
-- Autostart necessary processes (notifications daemon, status bar, wallpaper, etc.)
...
-- Persistent Glass & Blur preset configuration
pcall(function()
    dofile(os.getenv("HOME") .. "/.config/hypr/glass.lua")
end)
